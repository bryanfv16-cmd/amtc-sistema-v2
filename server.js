...
async function initDb() {
  await pool.query(`
    CREATE TABLE IF NOT EXISTS certificados (
      ...
      tipo TEXT DEFAULT 'Certificación y validación intumescente',
      espesor TEXT,
...
app.get('/pdf/:codigo', async (req, res) => {
  const result = await pool.query('SELECT pdf_nombre, pdf_data FROM certificados WHERE codigo=$1', [req.params.codigo]);
